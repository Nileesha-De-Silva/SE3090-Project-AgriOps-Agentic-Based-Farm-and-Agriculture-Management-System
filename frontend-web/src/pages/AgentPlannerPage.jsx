...
import { getFields, getCropSeasons } from "../services/farmApi";
import { generatePlan } from "../services/agentPlannerApi";
  ...
  return (
    <div className="agent-planner-page">
      ...
      <p className="agent-planner-intro">
        Select a field and crop season, then let Agent 1 generate a recommended seasonal operational plan.
      </p>
      ...
      {generating && (
        <Card className="planner-loading-card">
          <LoadingSpinner label="Agent 1 is analyzing field data & weather telemetry..." />
        </Card>
      )}
